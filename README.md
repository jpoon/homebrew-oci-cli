**:warning: With Oracle releasing an official formula, this project is deprecated. Please migrate to using the [official formula](https://formulae.brew.sh/formula/oci-cli). :warning:**
